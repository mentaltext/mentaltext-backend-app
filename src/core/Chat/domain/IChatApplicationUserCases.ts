...
import { FindChatParticipants, SaveChatParticipants } from "@/core/ChatParticipants/domain/IChatParticipantsApplicationImplementations";
...
export type TCreateChatUseCase = EndpointHandler<
  [SaveChat, FindUser, SaveChatParticipants, SaveChatSettings, FindChatParticipants],
  TCreateChatReqBody
>;
